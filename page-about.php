...
<main class="page">
  <section class="about">
    ...
    <div class="container container_about">
      ...
      <div class="about-item about-item_methods">
        ...
        <p class="item-title">Заполнить форму <a href="#">бронирования</a></p>
      </div><!-- methods -->
    </div><!-- container_about -->    
  </section><!-- about -->
  ...
  <section class="transfer">
    ...
    <div class="wrapper-transfer">
      <div class="item transfer-text">
        <p class="about-text">Если Вы планируете свой отпуск заблаговременно, то можете воспользоваться нашей службой
          такси.
  ...
  <section class="feedback">
    <h2 class="title-section">Отзывы наших пассажиров</h2>
    <span class="item-title feedback-name">Надежда Л.</span>
    <p class="about-text">Поездка из Ростова-на-Дону
      до станицы Должанская и обратно,
      все супер, очень комфортно.
      Буду рекомендовать и воспользуюсь ещё обязательно!!!
      Большое спасибо.
    </p>
